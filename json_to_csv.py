...
if not os.path.isfile("data/category_header.csv"):
    with open("dataset/business.json") as business_json, \
        ...
        business_category_writer = csv.writer(business_category_csv, escapechar='\\', quotechar='"', quoting=csv.QUOTE_ALL) # business_IN_CATEGORY_category.csv
        category_writer = csv.writer(categories_csv, escapechar='\\', quotechar='"', quoting=csv.QUOTE_ALL)                 # category.csv
        ...
        for line in business_json.readlines():
            ...
            if item["categories"] != None:
                ...
                x = item["categories"].split(',')   # error cases: "Trusts, & Probates"
            ...
            for category in x:
                ...
                #print( [item["business_id"], category] )
